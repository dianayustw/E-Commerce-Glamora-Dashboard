...
# ============================================[ Page Setup ]=====================================================
st.set_page_config(page_title="Glamora", page_icon=":bar_chart:", layout="wide")
...
st.header('Glamora E-Commerce Dashboard :bar_chart:')
...
# Delivery Status Comparison ____________________________________________________________________________________
...
# Ratio of Payment Types ________________________________________________________________________________________
with col2:
    fig = px.pie(
        payment_type_df,
        values='order_count',
...
st.caption('Copyright © Dian Ayu Setiawati 2024')
